...
import { ClipboardIcon, LucideAngularModule } from 'lucide-angular';

@Component({
  selector: 'z-block-code-viewer',
  standalone: true,
  imports: [SimpleCodeHighlightComponent, FileTreeComponent, LucideAngularModule, ZardBreadcrumbModule],
