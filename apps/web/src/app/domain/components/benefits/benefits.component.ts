...
import { CodeIcon, HeartIcon, LayersIcon, LucideAngularModule, PaletteIcon, ShieldIcon, ZapIcon } from 'lucide-angular';
...
@Component({
  ...
  imports: [LucideAngularModule, ZardBadgeComponent],
  template: `
