    ...
    <section class="min-h-screen max-w-4xl mx-auto">
      ...
      <footer class="flex justify-center mt-8">
        <a z-button zType="ghost" routerLink="/components/button" class="group"
          >View all
          <i-lucide [img]="ChevronRightIcon" class="shrink-0 transition-all duration-300 ease-out group-hover:translate-x-1" />
        </a>
      </footer>
    </section>
  `,
  imports: [LucideAngularModule, RouterModule, ZardCardComponent, ZardButtonComponent, ZardCardComponent, ZardBadgeComponent, ZardCheckboxComponent, ZardInputDirective],
})
